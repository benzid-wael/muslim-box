        ...
        {license.licenseValid ? (
          <div className="box">
            ...
            <div>
              ...
              {license.allowedMajorVersions} <br />
              <strong>Minor versions:</strong>{" "}
              {license.allowedMinorVersions} <br />
              <strong>Patch versions:</strong>{" "}
              {license.allowedPatchVersions} <br />
  ...
  return (
    <Nav className="navbar" role="navigation" aria-label="main navigation" event={state.event}>
      ...
      <div id="navbarBasicExample"
        className={`navbar-menu ${desktopMenuActive ? "is-active" : ""}`}>

        <License open={state.licenseModalActive}
